...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_import_status_user_id"), "import_status", ["user_id"], unique=False
    )
    op.create_table(
        "steam_games",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_steam_games_steam_app_id"),
        "steam_games",
        ["steam_app_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_pile_snapshots_id"), "pile_snapshots", ["id"], unique=False
    )
